...
export const getMeetingId = (state) => getModel(state).get("meetingId");
...
export const getCreateStatus = (state) => getModel(state).get("create");
export const getRow = (state) => getModel(state).get("row");
